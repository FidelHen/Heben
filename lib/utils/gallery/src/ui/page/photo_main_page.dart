...
import 'package:heben/utils/gallery/src/delegate/loading_delegate.dart';
import 'package:heben/utils/gallery/src/engine/lru_cache.dart';
import 'package:heben/utils/gallery/src/engine/throttle.dart';
import 'package:heben/utils/gallery/src/entity/options.dart';
import 'package:heben/utils/gallery/src/provider/asset_provider.dart';
import 'package:heben/utils/gallery/src/provider/config_provider.dart';
import 'package:heben/utils/gallery/src/provider/gallery_list_provider.dart';
import 'package:heben/utils/gallery/src/provider/i18n_provider.dart';
import 'package:heben/utils/gallery/src/provider/selected_provider.dart';
import 'package:heben/utils/gallery/src/ui/dialog/change_gallery_dialog.dart';
      ...
      child: Column(
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child:
                Text('Loading', style: GoogleFonts.lato(color: Colors.white)),
          ),
        ],
